...
class DataBaseProvider
{
    public static function setup()
    {
        if(!R::testConnection()) {
            $db = [
                ...
                'name' => 'testdb',     //DEFINE DATABASE
                'user' => 'root',       //DEFINE DATABASE USER
                'password' => ''        //DEFINE DATABASE USER PASSWORD
            ];
    ...
    public function CreateRow(string $table, array $data)
    {
        ...
        catch (Exception $e)
        {
            ...
            $Responder->AddError($e->getMessage());
            $Responder->AddConsoleLog($e->getMessage());
            return false;
        }
